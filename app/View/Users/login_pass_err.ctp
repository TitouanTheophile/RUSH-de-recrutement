...
<?= $this->Form->input('email', array('label' => 'Email', "placeholder" => "kod@social.mehh", 'class' => "small_form_field")); ?>
<?= $this->Form->input('password', array('label' => 'Mot De Passe', 'class' => "small_form_field")); ?>
