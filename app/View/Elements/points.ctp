...
<?php $points = $this->requestAction("contents/getPoints/$id"); ?>
	<div class="like_div">
		<?php $action = (!empty($points['Points']) && $points['Points'][0]['pointType'] == 1 ? 'removePoint' : 'addPoint'); ?>
	...
	<div class="connard_div">
		<?php $action = (!empty($points['Points']) && $points['Points'][0]['pointType'] == 2 ? 'removePoint' : 'addPoint'); ?>
